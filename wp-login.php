<!DOCTYPE html>
	...
	<title>QuantiModo &lsaquo; Log In</title>
...
<style>.login h1 a { background-image: url("/wp-content/uploads/2015/11/QM-LOGO-CRAZY-ARROWS-Mike-Bigger-300-60-Mobile1_yzbrhw.png");background-size: contain;min-height: 88px;width:auto;}#login {padding: 20px 0 0;}.login #nav a, .login #backtoblog a {color:!important;text-shadow:none;}</style>
...
<meta name="msapplication-TileImage" content="https://quantimo.do/wp-content/uploads/2017/02/QM-LOGO-ICON-144-flat-arrow-butt.png" />
	...
	<body class="login login-action-login wp-core-ui  locale-en-us jetpack-sso jetpack-sso-form-display">
		<div id="login">
		<h1><a href="/" title="QuantiModo" tabindex="-1">QuantiModo</a></h1>
	...
	<p>
		...
		<input type="password" name="pwd" id="user_pass" class="input" value="" size="20" /></label>
			...
			<div id="jetpack-sso-wrap__action">
				<a rel="nofollow" href="/wp-login.php?action=jetpack-sso&#038;redirect_to=https%3A%2F%2F%2Fwp-admin%2Fnav-menus.php" class="jetpack-sso button button-primary"><span><span class="genericon genericon-wordpress"></span> Log in with WordPress.com</span></a>
									<p>
						You can now save time spent logging in by connecting your WordPress.com account to QuantiModo.					</p>
							</div>
				...
				<a href="/wp-login.php?redirect_to=https%3A%2F%2F%2Fwp-admin%2Fnav-menus.php&#038;reauth=1&#038;jetpack-sso-show-default-form=1" class="jetpack-sso-toggle wpcom">
					Log in with username and password				</a>

				<a href="/wp-login.php?redirect_to=https%3A%2F%2F%2Fwp-admin%2Fnav-menus.php&#038;reauth=1&#038;jetpack-sso-show-default-form=0" class="jetpack-sso-toggle default">
...
if(typeof wpOnload=='function')wpOnload();
	...
	<p id="backtoblog"><a href="/">&larr; Back to QuantiModo</a></p>
